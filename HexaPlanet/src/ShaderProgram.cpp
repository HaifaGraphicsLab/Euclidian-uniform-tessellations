...
bool ShaderProgram::loadShaders(const char* vsFilename, const char* fsFilename) {
	// get strings of shader file contents
	...
	// create program (and attatch to program handle)
...
// returns the file as one long string
string ShaderProgram::fileToString(const string& filename)
{
	...
	try
	{
		...
		std::cerr << "Error reading shading file" << filename << std::endl;
	}
	return ss.str();
}
